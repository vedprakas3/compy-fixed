...
export function useFormPersistence<T extends Record<string, any>>(
  ...
  const [persistedData, setPersistedData] = useLocalStorage<T>(storageKey, defaultValues);
  const [formData, setFormData] = useState<T>(persistedData);
  ...
  }, [defaultValues, setPersistedData]);
